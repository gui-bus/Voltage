...
import { ChartBar, Cpu, Lightning, Waves } from "@phosphor-icons/react";
  ...
  const specs = [
    {
      icon: <Waves size={20} />,
      label: t("specs.audio"),
      value: t("specs.audioValue"),
    },
    {
      icon: <Cpu size={20} />,
      label: t("specs.visuals"),
      value: t("specs.visualsValue"),
    },
    {
      icon: <ChartBar size={20} />,
      label: t("specs.energy"),
      value: t("specs.energyValue"),
    },
  ];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-0 w-px bg-linear-to-b from-transparent via-white/20 to-transparent hidden lg:block z-20"
      />
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-8 w-full max-w-md">
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-black text-white/20 tracking-[0.3em] uppercase underline underline-offset-8 decoration-purple-500/50">
                {t("capacity")}
              </span>
