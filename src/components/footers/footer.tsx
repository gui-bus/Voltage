...
export function Footer() {
  ...
  return (
    <footer
      className="bg-black border-t border-white/5 relative overflow-hidden"
      id="footer"
    >
      {/* Background Accent */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-linear-to-r from-transparent via-purple-500/20 to-transparent" />

      <div className="max-w-450 mx-auto px-6 lg:px-12 py-24 md:py-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-1 flex flex-col items-start">
            <Link href="/" className="flex items-center gap-4 mb-8 group">
              <Lightning
                weight="fill"
                size={40}
                className="text-white group-hover:text-purple-500 transition-colors"
              />
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black tracking-[0.4em] text-purple-500 uppercase mb-8 italic">
              {t("nav")}
            </span>
          ...
          {/* Column 3: Legal */}
          <div className="flex flex-col">
            <span className="text-[10px] font-black tracking-[0.4em] text-white/20 uppercase mb-8 italic">
              {t("info")}
            </span>
            <nav className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="p-8 border border-white/5 bg-[#0a0a0a] relative group">
              <p className="text-sm font-bold text-white/60 uppercase italic mb-6">
                {t("join")}
              </p>
              <button
                type="button"
                className="w-full h-12 bg-white text-black font-black text-[10px] tracking-[0.3em] uppercase hover:bg-purple-500 transition-colors"
              >
                {t("connect")}
              </button>
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <button
            ...
            type="button"
          >
            <span className="text-[10px] font-black text-white/40 group-hover:text-white tracking-[0.3em] uppercase transition-colors italic">
              {t("top")}
            </span>
