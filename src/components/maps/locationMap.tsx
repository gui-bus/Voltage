          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-purple-500 tracking-widest uppercase mb-2">
                  {t("location")}
                </span>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-lg font-bold text-white/40 uppercase tracking-tight">
                  {t("addrValue")}
                </p>
              </div>
